...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/displayData.js */ \"./src/modules/displayData.js\");\n\n\n\n// displayTodo(task.getTasks());\n\nconst refresh = document.querySelector('.refresh');\nlet rotate = -360;\nrefresh.addEventListener('click', () => {\n  refresh.style.transform = `rotate(${rotate}deg)`;\n  rotate -= 360;\n});\n\nconst add = document.querySelector('.add');\nconst input = document.querySelector('.text');\n\nadd.addEventListener('click', () => {\n  _modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.task.add(input.value);\n  input.value = '';\n  (0,_modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.displayTodo)();\n});\n\ninput.addEventListener('keydown', (e) => {\n  if (e.key === 'Enter') {\n    _modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.task.add(input.value);\n    input.value = '';\n    _modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.task.populateStorage();\n    (0,_modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.displayTodo)();\n  }\n});\n\nconst clear = document.getElementById('clear');\nclear.addEventListener('click', () => {\n  _modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.task.clear();\n  (0,_modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.displayTodo)();\n});\n\nconst populate = () => {\n  if (localStorage.getItem('tasks')) {\n    _modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.task.setTasks();\n    (0,_modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.displayTodo)();\n  } else {\n    (0,_modules_displayData_js__WEBPACK_IMPORTED_MODULE_1__.displayTodo)();\n  }\n};\n\npopulate();\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
